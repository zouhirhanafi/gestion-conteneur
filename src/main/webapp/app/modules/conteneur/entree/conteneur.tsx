...
export const Conteneur = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const conteneurList = useAppSelector(state => state.conteneurEntree.entities);
  const loading = useAppSelector(state => state.conteneurEntree.loading);
  const totalItems = useAppSelector(state => state.conteneurEntree.totalItems);
  const links = useAppSelector(state => state.conteneurEntree.links);
  const entity = useAppSelector(state => state.conteneurEntree.entity);
