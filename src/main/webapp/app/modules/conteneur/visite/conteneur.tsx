...
export const Conteneur = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const conteneurList = useAppSelector(state => state.conteneurVisite.entities);
  const loading = useAppSelector(state => state.conteneurVisite.loading);
  const totalItems = useAppSelector(state => state.conteneurVisite.totalItems);
  const links = useAppSelector(state => state.conteneurVisite.links);
  const entity = useAppSelector(state => state.conteneurVisite.entity);
