...
export const Conteneur = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const conteneurList = useAppSelector(state => state.conteneurFinVisite.entities);
  const loading = useAppSelector(state => state.conteneurFinVisite.loading);
  const totalItems = useAppSelector(state => state.conteneurFinVisite.totalItems);
  const links = useAppSelector(state => state.conteneurFinVisite.links);
  const entity = useAppSelector(state => state.conteneurFinVisite.entity);
