...
export const ConteneurUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const conteneurEntity = useAppSelector(state => state.conteneurListe.entity);
  const loading = useAppSelector(state => state.conteneurListe.loading);
  const updating = useAppSelector(state => state.conteneurListe.updating);
  const updateSuccess = useAppSelector(state => state.conteneurListe.updateSuccess);

  const handleClose = () => {
    props.history.push('/conteneur/liste');
  };
