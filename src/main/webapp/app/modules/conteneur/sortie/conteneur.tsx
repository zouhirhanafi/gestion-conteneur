...
export const Conteneur = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const conteneurList = useAppSelector(state => state.conteneurSortie.entities);
  const loading = useAppSelector(state => state.conteneurSortie.loading);
  const totalItems = useAppSelector(state => state.conteneurSortie.totalItems);
  const links = useAppSelector(state => state.conteneurSortie.links);
  const entity = useAppSelector(state => state.conteneurSortie.entity);
