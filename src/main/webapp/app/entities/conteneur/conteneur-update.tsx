        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('gestionConteneurApp.conteneur.zone')}
                id="conteneur-zone"
                name="zone"
                data-cy="zone"
                type="text"
              />
              <ValidatedField
                label={translate('gestionConteneurApp.conteneur.ligne')}
                id="conteneur-ligne"
                name="ligne"
                data-cy="ligne"
                type="text"
              />
              <ValidatedField
                label={translate('gestionConteneurApp.conteneur.colonne')}
