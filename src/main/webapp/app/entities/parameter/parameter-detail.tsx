    ...
    <Row>
      <Col md="8">
        <h2 data-cy="parameterDetailsHeading">
          <Translate contentKey="gestionConteneurApp.parameter.detail.title">Parameter</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="label">
              <Translate contentKey="gestionConteneurApp.parameter.label">Label</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="lib3">
              <Translate contentKey="gestionConteneurApp.parameter.lib3">Lib 3</Translate>
            </span>
          </dt>
          <dd>{parameterEntity.lib3}</dd>
          <dt>
            <span id="refExterne">
              <Translate contentKey="gestionConteneurApp.parameter.refExterne">Ref Externe</Translate>
            </span>
          </dt>
          <dd>{parameterEntity.refExterne}</dd>
          <dt>
            <span id="val1">
              <Translate contentKey="gestionConteneurApp.parameter.val1">Val 1</Translate>
            </span>
          </dt>
          <dd>{parameterEntity.val1}</dd>
          <dt>
            <span id="val2">
              <Translate contentKey="gestionConteneurApp.parameter.val2">Val 2</Translate>
            </span>
          </dt>
          <dd>{parameterEntity.val2}</dd>
          <dt>
            <span id="val3">
              <Translate contentKey="gestionConteneurApp.parameter.val3">Val 3</Translate>
            </span>
          </dt>
          <dd>{parameterEntity.val3}</dd>
          <dt>
            <span id="ordre">
              <Translate contentKey="gestionConteneurApp.parameter.ordre">Ordre</Translate>
            </span>
          </dt>
          <dd>{parameterEntity.ordre}</dd>
          <dt>
            <Translate contentKey="gestionConteneurApp.parameter.type">Type</Translate>
          </dt>
          <dd>{parameterEntity.type ? parameterEntity.type.id : ''}</dd>
          <dt>
            <Translate contentKey="gestionConteneurApp.parameter.paraent">Paraent</Translate>
          </dt>
