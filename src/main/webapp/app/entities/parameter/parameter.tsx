  ...
  return (
    <div>
      <h2 id="parameter-heading" data-cy="ParameterHeading">
        <Translate contentKey="gestionConteneurApp.parameter.home.title">Parameters</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gestionConteneurApp.parameter.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gestionConteneurApp.parameter.home.createLabel">Create new Parameter</Translate>
          </Link>
        </div>
      </h2>
        ...
        {parameterList && parameterList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gestionConteneurApp.parameter.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('lib3')}>
                  <Translate contentKey="gestionConteneurApp.parameter.lib3">Lib 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('refExterne')}>
                  <Translate contentKey="gestionConteneurApp.parameter.refExterne">Ref Externe</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('val1')}>
                  <Translate contentKey="gestionConteneurApp.parameter.val1">Val 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('val2')}>
                  <Translate contentKey="gestionConteneurApp.parameter.val2">Val 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('val3')}>
                  <Translate contentKey="gestionConteneurApp.parameter.val3">Val 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('ordre')}>
                  <Translate contentKey="gestionConteneurApp.parameter.ordre">Ordre</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="gestionConteneurApp.parameter.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="gestionConteneurApp.parameter.paraent">Paraent</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gestionConteneurApp.parameter.home.notFound">No Parameters found</Translate>
            </div>
          )
        )}
      </div>
